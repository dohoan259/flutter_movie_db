...
import '../data/repository/remote/interceptor/logging_interceptor.dart' as _i10;
...
import 'network_model.dart' as _i11;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i9.Interceptor>(_i10.LoggingInterceptor(),
      instanceName: 'logging_interceptor');
  gh.singleton<_i9.Interceptor>(networkModule.getApiKeyInterceptor(),
      instanceName: 'api_key_interceptor');
  gh.singleton<_i9.Dio>(networkModule.getDio(
      get<_i9.Interceptor>(instanceName: 'api_key_interceptor'),
      get<_i9.Interceptor>(instanceName: 'logging_interceptor')));
  gh.singleton<_i5.ApiService>(networkModule.getService(get<_i9.Dio>()));
  return get;
}
